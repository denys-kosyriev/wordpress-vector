...
<main class='company blog'>
  <section class='top'>
    <div class='container'>
      <h1>Ми працюємо під гаслом "Максимум послуг за мінімальною ціною"</h1>
      <p>
        ТРК "Вектор" пропонує широкий вибір каналів і послуг кабельного телебачення. Компанія забезпечує надійну мережу
        з використанням сучасних технологій. Абонентська плата включає витрати на енергоносії, такі як електрика для
        живлення оптичних кабелів і підсилювачів телесигналу, а також на утримання опалення і кондиціонування для
        забезпечення нормальної роботи обладнання.
      </p>
      <p>
        З першого січня 2012 року компанія буде змушена підвищити ціни через зростання витрат на енергонесії,
        підвищення вартості трансляції іноземних телеканалів, збільшення кількості каналів та заміну обладнання.
        Керівництво компанії збільшує ціни на мінімальний відсоток, враховуючи фінансове навантаження на громадян. За
        попередню оплату послуг на рік, ціни залишаться незмінними. Компанія надає якісний цілодобовий сервіс з
        безперервною трансляцією і має дружній колектив.
      </p>
    </div>
  </section>
  ...
  <section class='bottom'>
    <div class='container'>
      ...
      <p>
        Телерадіокомпанія "Вектор" розташована у місті Лозова, Харківської області. Вона була заснована в 1996 році як
        ТОВ "Лозівське підприємство телевізійних антен" і пізніше перетворилася на ТРК "Вектор" у 1998 році. Компанія
        почала з обслуговування колективних антен у багатоповерхових будинках міста, але з часом розширила свою
        діяльність і створила мережу кабельного телебачення.
      </p>
      <p>
        На сьогоднішній день кабельне телебачення ТРК "Вектор" охоплює центр міста і південно-східний житловий масив. У
        мережі ретранслюється 66 каналів у двох пакетах: соціальному та базовому. Крім того, планується розширення до 80
        каналів і введення кабельного Інтернету.
      </p>
      <p>
        Компанія просить кожного абонента не допускати накопичення заборгованості, вчасно сплачувати за послуги
        Інтернет і кабельного ТБ.
      </p>
      <p>
        ТРК "Вектор" надає стабільні та якісні послуги, має систему цілодобового прийому заявок і оперативного
        виконання. Кількість абонентів щороку збільшується на 20%. Компанія також випускає газету "Вектор плюс" з
        програмами всіх ретранслюються каналів та інформаційним матеріалом про життя міста.
      </p>
      <p>
        Транслює різні типи програм, включаючи інформаційні, соціальні, економічні та релігійні програми.
        Вона також надає рекламні послуги, включаючи виробництво і трансляцію рекламних роликів.
      </p>
      <p>
        Компанія активно працює над впровадженням нових технологій і постійно підвищує якість своїх послуг. Вона
        відповідає новим законодавчим вимогам і має затверджений Редакційни
      </p>
    </div>
  </section>
</main>
