      ...
      <div class='wrapper'>
        <div class='flex'>
          ...
          <div class='phone-numbers'>
            ...
            <?php if (have_rows('footer_phones_advertising', 'option')) :
              while (have_rows('footer_phones_advertising', 'option')) :
                the_row(); ?>
                <ul>
                  <li>
                    <h3><?php echo get_sub_field('title_advertising') ?></h3>
                  </li>
                  <?php if (have_rows('phones', 'option')):
                    while (have_rows('phones', 'option')):
                      the_row();
...
<path d="M40.5,31.5v-18c0,0-18.2,12.7-19.97,13.359C18.79,26.23,0.5,13.5,0.5,13.5v18c0,2.5,0.53,3,3,3h34
	...
	c0,0,18.069,12.44,20,13.12C22.57,22.71,40.5,10.1,40.5,10.1L40.471,9.971z" />
            ...
            <li class='footer-location'>
              ...
              <a
                target="_blank"
                href='<?php echo get_field('footer_map', 'option') ?>'>
                <?php echo get_field('footer_map', 'option') ?>
              </a>
            </li>
          </ul>
          <ul class='socials'>
