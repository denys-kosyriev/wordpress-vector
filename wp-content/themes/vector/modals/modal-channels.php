...
<div class='modal modal-channels d-none'>
  <div class='channels p-relative modal-content'>
    <div class='modal-channels-header'>
      ...
      <ul class='buttons'>
        <li>
          <button class='btn btn-switch-channels btn-switch analog-btn active'>
            Аналогові канали
          </button>
        </li>
        <li>
          <button class='btn btn-switch-channels btn-switch digital-btn'>
            Цифрові канали
          </button>
        </li>
      </ul>
    ...
    <?php if (have_rows('modal_channels_channel_network', 'option')) :
      while (have_rows('modal_channels_channel_network', 'option')) :
        the_row(); ?>
        <div class='scroll-channels d-none'>
